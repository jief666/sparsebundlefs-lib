...
#include <memory.h>
	...
	static uint64_t m_keySchedule[16];
	static uint64_t m_initVector;


const uint8_t m_ip_box[64] = {
...
const unsigned int m_shifts[16] = {
